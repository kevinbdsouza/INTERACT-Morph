...
- Generated: `2026-04-25T12:46:33.309794+00:00`
...
| Placeholder handoff readiness evidence | `data/canonical/family_a/manifests/reports/data_handoff_check_placeholder_v1.json` | True | name=family_a_data_handoff_check, created_at_utc=2026-04-25T12:41:51.048504+00:00, ready=True, run_count=120, ready_run_count=120, error_count=0, warning_count=0, recommended_run_id_mode=preserve, next_action_count=2, next_actions=[{'priority': 'P0', 'type': 'run_pipeline'}, {'priority': 'P1', 'type': 'attach_governance_evidence'}] |
| Placeholder smoke-check bundle | `data/canonical/family_a/manifests/reports/smoke_check_report_placeholder_v1.json` | True | name=mvp_local_smoke_checks, created_at_utc=2026-04-25T12:41:51.055938+00:00, passed=True, check_count=4 |
| Placeholder split artifact | `data/canonical/family_a/manifests/splits/family_a_placeholder_v1.json` | True | created_at_utc=2026-04-25T12:41:39.575048+00:00 |
| Placeholder baseline report | `data/canonical/family_a/manifests/reports/baseline_family_a_placeholder_v1.json` | True |  |
| Placeholder dataset snapshot | `data/canonical/snapshots/family_a_placeholder_v1.json` | True | created_at_utc=2026-04-25T12:41:39.748722+00:00, run_count=120 |
| Placeholder multimodal eval | `data/canonical/family_a/manifests/models/family_a_placeholder_v1_multimodal.eval.json` | True | created_at_utc=2026-04-25T12:44:48.742894+00:00 |
| Placeholder calibration report | `data/canonical/family_a/manifests/models/family_a_placeholder_v1_multimodal.calibration.json` | True | name=family_a_uncertainty_calibration_v1, created_at_utc=2026-04-25T12:44:56.971468+00:00 |
| Placeholder model card | `data/canonical/family_a/manifests/model_cards/family_a_placeholder_v1_multimodal.md` | True |  |
| Placeholder recommendation report | `data/canonical/family_a/manifests/models/family_a_placeholder_v1_multimodal.recommendations.json` | True | name=family_a_recommendation_v1, created_at_utc=2026-04-25T12:45:11.480831+00:00 |
| Placeholder recommendation UI | `data/canonical/family_a/manifests/reports/family_a_placeholder_v1_recommendations_ui.html` | True |  |
